...
| `@deepseek-ai/dsh` `0.1.7-rc.1` | **आवश्यक**; मेल खाते checkout (`typecheck`) और प्रकाशित पैकेजों (`typecheck:ci`, 214 टेस्ट) दोनों पर सत्यापित |
...
pnpm run typecheck:ci   # प्रकाशित 0.1.7-rc.1 faces के विरुद्ध (CI यही चलाता है)
pnpm test
pnpm run build

...
| `@deepseek-ai/dsh` `0.1.7-alpha.2` | **obrigatória**; verificada contra o checkout correspondente (`typecheck`) e os pacotes publicados (`typecheck:ci`, 214 testes) |
...
pnpm run typecheck:ci   # contra as faces publicadas 0.1.7-alpha.2 (o que a CI executa)
pnpm test
pnpm run build
